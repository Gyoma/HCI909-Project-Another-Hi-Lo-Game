...
class GameState():
    def __init__(self, first_player_cards, second_player_cards, rounds_left, first_player_win_rounds, second_player_win_rounds):
        ...
        # self.first_player_available_cards = random.sample(self.first_player_cards, 6) if len(
        #     self.first_player_cards) > 6 else self.first_player_cards
        # self.second_player_available_cards = random.sample(self.second_player_cards, 6) if len(
        #     self.second_player_cards) > 6 else self.second_player_cards
